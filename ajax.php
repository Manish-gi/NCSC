...
if($action == 'save_employee_info'){
	$save = $crud->save_employee_info();
	if($save)
		echo $save;
}
if($action == 'save_employee_nominee'){
	$save = $crud->save_employee_nominee();
	if($save)
		echo $save;
}
if($action == 'login2'){
...
if($action == "save_entity"){
	$save = $crud->save_entity();
	if($save)
		echo $save;
}
if($action == "delete_entity"){
	$save = $crud->delete_entity();
	if($save)
		echo $save;
}
...
if($action == "gene_report"){
	$save = $crud->gene_report();
	if($save)
		echo $save;
}