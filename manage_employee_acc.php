            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="acc_no" id="acc_no" cols="30" rows="2" class="form-control" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="" class="control-label">Bank Name</label>
                        <textarea name="acc_name" id="acc_name" cols="30" rows="2" class="form-control" required></textarea>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        $('#employee_info').submit(function(e) {
            e.preventDefault()
            start_load();
            $.ajax({
                url: 'ajax.php?action=save_employee_info',
                method: "POST",
