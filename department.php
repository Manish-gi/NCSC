				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<textarea name="dept_name" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$department = $conn->query("SELECT * FROM department order by dept_id asc");
								...
								<tr>
									...
									<td class="">
										 <p> <b><?php echo $row['dept_name'] ?></b></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_department" type="button" data-id="<?php echo $row['dept_id'] ?>" data-name="<?php echo $row['dept_name'] ?>"  >Edit</button>
...
<script>
	...
	$('.edit_department').click(function(){
		...
		cat.find("[name='dept_name']").val($(this).attr('data-name'))
		end_load()
	})
