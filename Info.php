					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<center>
										<button class="btn btn-sm btn-outline-primary view_info" data-id="<?php echo $row['emp_id'] ?>" type="button"><i class="fa fa-eye"></i></button>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#table tbody").on("click", ".view_info",function() {
			var $emp_id = $(this).attr('data-id');
			uni_modal("Employee Details", "view_info.php?emp_id=" + $emp_id, "mid-large")

		});

		// $('#new_emp_btn').click(function() {
		// 	uni_modal("New Employee", "manage_info.php")
		// });
