...
$emp = $conn->query("SELECT e.*,d.dept_name as dname,p.pos_name as pname FROM employee e inner join department d on e.dept_id = d.dept_id inner join position p on e.pos_id = p.pos_id where e.emp_id =" .$emp_id)->fetch_array();
foreach ($emp as $k => $v) {
	$$k = $v;
}
?>
			...
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
						<ul class="list-group">
							<?php
							$acc = $conn->query("SELECT * FROM emp_acc where emp_id=". $emp_id );
			...
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
						<ul class="list-group">
							<?php
							$nominee = $conn->query("SELECT * FROM emp_nominee where emp_id=". $emp_id);
